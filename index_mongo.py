...
# SPECIFICATION: This is the driver program that interacts with the user to
# manage the documents and generate the inverted index using the functions
# defined in db_connection_mongo.py. It provides a menu-driven interface for
# creating, updating, deleting documents, and displaying the inverted index.
